...
df_desc = pd.read_csv(caminho_base+'\\base_descricao.csv',
                         sep=';', 
                         decimal=',',
                         encoding='latin-1'
                        ) 
...
import matplotlib.pyplot as plt   # Matplotlib para criar gráficos

# Criando um DataFrame com os dados de mês e preço
data = {
    'MES': ['JAN', 'FEV', 'MAR', 'ABR', 'MAI', 'JUN', 'JUL', 'AGO', 'SET', 'OUT', 'NOV', 'DEZ'],
    'PREÇO': [1000, 1050, 1035, 1110, 1220, 1190, 1140, 1250, 1245, 1220, 1270, 1300]
}

# Criando o DataFrame com Pandas
df = pd.DataFrame(data)

# Exibindo o DataFrame para ver os dados
print(df)


# Definindo os dados para o eixo X e Y
x = df['MES']  # A coluna 'MES' representa os meses no eixo X
y = df['PREÇO']  # A coluna 'PREÇO' representa os preços no eixo Y


# Criando o gráfico de linhas
plt.plot(x, y)

# Criando o gráfico de linhas com marcadores e cor personalizada

# marker='o': Adiciona marcadores circulares nos pontos de dados.
# color='b': Define a cor da linha como azul ('b').
# linestyle='--': Muda o estilo da linha para tracejada.
# plt.grid(True): Ativa a grade no fundo do gráfico, facilitando a leitura.
